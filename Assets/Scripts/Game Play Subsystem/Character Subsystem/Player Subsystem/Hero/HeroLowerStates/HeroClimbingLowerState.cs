...
public class HeroClimbingLowerState : PlayerLowerStateBase<HeroLowerState>
{
    /****** Public Members ******/
    ...
    public override void InitializeState(IStateController<HeroLowerState> stateController, IMotionController playerPhysics, ICharacterInfo playerInfo, Animator lowerAnimator)
    {
