...
public class SaveLoadUIState : MonoBehaviour, IUIContoller
{
    ...
    public void StartUI()
    {
        ...
        if (true)//UIController.Instance.CurrentState == UIController.STATE.SAVE)
        {
    ...
    private void LoadSavedData()
    {
        ...
        PlayerManager.Instance.PlayerData = selectedSlot.slotData;
        //GameSceneController.Instance.LoadStage();
    ...
    class DataSlot
    {
        ...
        {
            if (true)//slotData == null && UIController.Instance.CurrentState == UIController.STATE.LOAD)
                return;
