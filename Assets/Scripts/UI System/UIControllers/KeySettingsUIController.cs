...
public class KeySettingsUIController : MonoBehaviour, IUIContoller
{
    ...
    // 현재 텍스트 트랜스폼을 설정하고 키 입력 대기 상태로 전환하는 메서드
    ...
    // Update 메서드에서 키 입력 감지 및 텍스트 업데이트
    private void Update()
    {
    ...
    // 경로를 통해 TextMeshProUGUI 컴포넌트의 텍스트를 수정하는 메서드
    ...
    // KeySetting을 업데이트하고 SettingsManager에 저장하는 메서드
