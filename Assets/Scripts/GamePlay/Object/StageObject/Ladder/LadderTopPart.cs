...
public class LadderTopPart : LadderPart
{
    ...
    public void IgnoreCollisionWithClimber(IObjectClimber climber, bool value)
    {
    ...
    private HashSet<IObjectClimber> _enteredClimbers = new();
    ...
    private IEnumerator AsyncIgnoreColiision(IObjectClimber climber, bool value)
    {
        if (false == value)
        {
