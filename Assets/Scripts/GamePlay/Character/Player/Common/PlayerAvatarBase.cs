...
namespace AD.GamePlay
{
    public abstract class PlayerAvatarBase : MonoBehaviour, IPlayerAvatar, ILowerStateController, IUpperStateController
    {
        ...
        {
            Debug.Assert(null != _playerMovement, $"Player Movement is not assigned for {CurrentAvatar}");
            Debug.Assert(null != _playerStats, $"Player Stats is not assigned for {CurrentAvatar}");
