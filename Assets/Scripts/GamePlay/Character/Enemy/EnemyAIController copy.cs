...
// public class EnemyAIControllera : MonoBehaviour, IStateController<EnemyStateType>
// {
//     /****** Public Members ******/
...
//     private Dictionary<EnemyStateType, EnemyAIStateBase> enemyStateDictionary;

//     private EnemyAIStateBase _currentState;
//     private ProjectilePoolHandler _weaponPoolHandler;
//     private EnemyPerception _terrainChecker;
...
//     {
//         enemyStateDictionary = new Dictionary<EnemyStateType, EnemyAIStateBase>();
...
//             foreach (var state in enemyStateTrans.GetComponents<EnemyAIStateBase>())
//             {
//                 if (!enemyStateDictionary.ContainsKey(state.GetState()))
//                     enemyStateDictionary[state.GetState()] = state;
//             }
//             _currentState = enemyStateDictionary[EnemyStateType.Patrolling];
//         }
//         else
//         {
...
//         {
//             _terrainChecker = checker.Result.GetComponent<EnemyPerception>();
//             _terrainChecker.InitializePerception(groundCheckingDistance, groundCheckingVector,
