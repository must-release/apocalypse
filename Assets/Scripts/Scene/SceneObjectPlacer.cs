...
{
    public static SceneObjectPlacer Instance;
    ...
    {
        // Check current scene
        SceneName currentScene = SceneObjectLoader.Instance.CurrentScene;
    ...
    {
        MapInfo firstMap = SceneObjectLoader.Instance.Maps.ElementAt(0);
    ...
    {
        SceneObjectLoader.Instance.Player.position = spawnMap.startingPoint.position;
    }
}